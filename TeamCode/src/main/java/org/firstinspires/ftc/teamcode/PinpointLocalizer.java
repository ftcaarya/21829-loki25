...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -172265.39146860433; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 104524.79311637659; // x position of the perpendicular encoder (in tick units)
    }

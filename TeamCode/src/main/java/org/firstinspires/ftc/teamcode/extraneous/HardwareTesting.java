...
public class HardwareTesting extends OpMode {
    ...
    public static double hor_right_retract = .25;

    public static double POOPER_BLOCK = 1;
    public static double POOPER_PASS = .4;

    public static double CLAW_OPEN = 1;
    public static double CLAW_CLOSE = 0.25;

    public static double wrist_left_down = 0;
    public static double wrist_left_up = 1;

    public static double wrist_right_down = 1;
    public static double wrist_right_up = 0;
    ...
    public static double rotate_hor = 0.22;
    public static double rotate_vert = 0.55;
